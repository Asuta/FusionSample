		...
		public override void FixedUpdateNetwork()
		{
			if (GetInput(out NetworkInputData data))
			{
				...
				if (delay.ExpiredOrNotRunning(Runner))
				{
					...
					{
						delay = TickTimer.CreateFromSeconds(Runner, 0.5f);
						Runner.Spawn(_prefabPhysxBall, transform.position+_left+ _up, Quaternion.LookRotation(_left), Object.InputAuthority, (runner, o) =>
						{
							o.GetComponent<PhysxBall>().Init( 10*_left );
						});
						spawned = !spawned;
					}
				}
